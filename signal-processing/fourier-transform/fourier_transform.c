...
#define PROGRAM_FILE "fourier_transform.cl"
#define KERNEL_FUNC "dft"
...
int main() 
{
    ...
    /* Read the results */
    err = clEnqueueReadBuffer(queue, data_buffer, CL_TRUE,
        0, NUM_POINTS * sizeof(float), output, 0, NULL, NULL);
    if(err < 0) 
    {
